...
\rfoot{\thepage}
\lfoot{\changefont <| title |>\\TH Köln // Fakultät für Informatik und Ingenieurwissenschaften\\ \today}
...
\usepackage[pdftex,plainpages=false,pdfpagelabels,
            pdftitle={ <| title |> Medieninformatik // TH Köln // Fakultät für Informatik und Ingenieurwissenschaften},
            pdfauthor={}
            ]{hyperref}
\hypersetup{
    colorlinks = true,
